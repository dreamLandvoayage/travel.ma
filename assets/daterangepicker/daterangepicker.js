...
end=maxDate.clone();if(this.minSpan&&this.maxSpan&&this.minSpan>this.maxSpan)
this.minSpan=this.maxSpan;if(this.minSpan&&end.clone().isBefore(start.clone().add(this.minSpan).subtract(1,'day').endOf('day')))
end=start.clone().add(this.minSpan).subtract(1,'day').endOf('day');if((this.minDate&&end.isBefore(this.minDate,this.timepicker?'minute':'day'))||(maxDate&&start.isAfter(maxDate,this.timepicker?'minute':'day')))
...
this.endDate=this.startDate.clone().add(this.maxSpan);if(this.minSpan&&this.endDate.clone().isBefore(this.startDate.clone().add(this.minSpan))){this.endDate=this.startDate.clone().add(this.minSpan).subtract(1,'day').endOf('day');}
this.previousRightTime=this.endDate.clone();this.container.find('.drp-selected').html(this.startDate.format(this.locale.format)+this.locale.separator+this.endDate.format(this.locale.format));if(!this.isShowing)
